/*
  ...
  =======================================
  22/10/2011      Ported to sword-bsp for OpenBoard(SWORD) imx233 by
  Airead Fan <fgh1987168@gmail.com>
...
#define printf(fmt,args...) sw_printf(fmt,##args)
#define strcpy(dest, src) sw_strcpy(dest, src)
...
static int dm9000_rx(struct eth_device *netdev, void (*NetReceive)(char *, int))	//zhai added callback functions
{
	...
	for (;;) {
		...
		if ((RxStatus & 0xbf00) || (RxLen < 0x40)
			...
			NetReceive(NetRxPackets[0], RxLen);		  //zhai 20110713
			break;	//zhai 2011013
		}
	}
	return 0;
...
int dm9000_initialize(void/*bd_t *bis*/)
{
	...
	//eth_register(dev);	//zhai comments
	dev->init(dev);
	return 0;
}
//added by zhai
